...
export const BOOKS: Record<string, Book> = {
  phb: {
    ...
    chapters: [
      ...
      {
        id: 'spontaneous-spells',
        title: 'Спонтанные Заклинания',
        file: 'phb/spontaneous-spells.html',
      },
      { id: 'metamagic', title: 'Метамагия', file: 'phb/metamagic.html' },
      {
        id: 'abstract-categories',
        title: 'Абстрактные Категории',
        file: 'phb/abstract-categories.html',
      },
      ...
      { id: 'leveling', title: 'Повышение Уровня', file: 'phb/leveling.html' },
      {
        ...
        file: 'phb/long-term-projects.html',
      },
  ...
  master: {
    ...
    chapters: [
      ...
      { id: 'how-to-gm', title: 'Как водить игру', file: 'master/how-to-gm.html' },
      {
        id: 'long-term-projects',
        title: 'Долгосрочные проекты',
        file: 'master/long-term-projects.html',
      },
