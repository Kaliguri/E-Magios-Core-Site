...
const NEWS_ENTRIES = [
  {
    id: '2025-12-10-secret-scrolls',
    date: '14 декабря 2025',
    title: 'Тайные Свитки — Обновление E\'Magios Core',
    brief: 'Настройки кубов - Навигация в БД - Группы заклинаний - Лист персонажа',
    features: [
      { text: 'В профиле можно выбрать собственный цвет сообщений для Discord через нативный color picker.' },
      { text: 'Добавлено меню настроек для броска кубов и новые варианты быстрых бросков.' },
      { text: 'Улучшено описание системы бросков и интеграции с Discord.' },
      { text: 'Улучшена работа поп-апов базы данных: добавлены кнопки Назад/Вперед (Undo/Redo) для удобной навигации.' },
      { text: 'Обновлены ссылки на правила: теперь они открывают соответствующие вкладки базы данных без перезагрузки страницы.' },
      { text: 'Улучшен интерфейс Групп Заклинаний: добавлены корректные формулы бросков для подзаклинаний.' },
      { text: 'Продолжается работа над Листом Персонажа: подготовка к системе крафта и оптимизация загрузки.' },
      { text: 'Многочисленные визуальные правки и улучшения стабильности.' }
    ],
    newObjects: {
      spells: [],
      schools: [],
  ...
  },
  {
    ...
    features: [
      ...
      { text: 'Упрощена поддержка базы: таблицы и попапы читают единую схему колонок и фильтров из schema.js?v=12ecd423 правки делаются в одном месте.' }
    ],
    newObjects: {
      spells: [],
      schools: [],
